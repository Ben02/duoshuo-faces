...
function(e, t, s) {
				...
				render: function(e) {
					...
					var g = i.el = H(et.replybox(h)).click(p),
						...
						w = g.find(".ds-add-emote").click(function(e) {
							...
							return w.toggleClass("ds-expanded").hasClass("ds-expanded") ? (s || (s = S.smiliesTooltip = new st.SmiliesTooltip, s.render(),DUOSHUO.addSmilies("滑稽", {
								"#[呵呵]": "呵呵",
								"#[哈哈]": "哈哈",
								"#[吐舌]": "吐舌",
								"#[啊]": "啊",
								...
								"#[大拇指]": "大拇指",
								"#[弱]": "弱"
							}), DUOSHUO.addSmilies("阿鲁", alu), DUOSHUO.addSmilies("微博", {
								"#[doge]": "doge",
								"#[miao]": "miao",
								"#[dog1]": "dog1",
								"#[dog2]": "dog2",
								...
								"#[yinxian]": "yinxian",
								"#[yiwen]": "yiwen",
								"#[youhengheng]": "youhengheng",
								"#[yun]": "yun",
								"#[zhuakuang]": "zhuakuang",
								"#[zhutou]": "zhutou",
								"#[zuiyou]": "zuiyou",
								"#[zuohengheng]": "zuohengheng",
								"#[geili]": "geili",
								"#[hufen]": "hufen",
								"#[jiong]": "jiong",
								"#[meng]": "meng",
    ...
    var s = S.smiliesTooltip;
    //这里有选择性的添加自己喜欢的表情来显示
    var arr = ['滑稽','微博','颜文字','阿鲁','斗图'];
    if (arr.some(function(x){return x === e})) {
        ...
        S.smilies[e] = t
				...
				render: function() {
					...
					}), a.find(".ds-smilies-container").delegate("img", "click", e), a.find(".ds-smilies-container").delegate("span", "click", e), this
				},
				reset: function(e) {
					function t(t, s) {
